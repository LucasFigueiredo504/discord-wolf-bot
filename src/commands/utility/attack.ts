...
const MESSAGES = {
  ...
  WOLF_TARGET: "Você não pode atacar outro Lobo!",
  FETCH_ERROR: "Erro ao buscar o jogador!",
  SUCCESS: (username: string) =>
    `Seu voto para matar ${username} foi registrado!`,
};
...
export async function execute(
  ...
  console.log(`Wolf ${interaction.user.id} targeted ${targetId} for attack`);
